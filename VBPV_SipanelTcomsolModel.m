...
function [model,TcellAve,TcellAveTop,TcellAveBack,TmodAve,TcellMax,Conv_AveTop,Conv_AveBack,Conv_AveSide,Rad_AveTop,Rad_AveBack,Rad_AveSide,CutLineCells,CutLineTop,CutLineBack,CutLineCellsX,CutLineTopX,CutLineBackX] = VBPV_SipanelTcomsolModel(Tamb,v_wind,Qcell,pathFolder,Tcell_init,a_coeff,b_coeff)
...
model.component('comp1').physics('ht').feature('hf2').set('h', 'b_coeff+a_coeff*v_wind');
